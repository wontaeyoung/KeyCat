...
struct PostDTO: DTO {
  ...
  init(from decoder: any Decoder) throws {
    ...
    self.post_id = try container.decodeWithDefaultValue(String.self, forKey: .post_id)
    ...
    self.likes = try container.decodeWithDefaultValue([String].self, forKey: .likes)
    self.likes2 = try container.decodeWithDefaultValue([String].self, forKey: .likes2)
    self.hashTags = try container.decodeWithDefaultValue([String].self, forKey: .hashTags)
    self.comments = try container.decodeWithDefaultValue([CommentDTO].self, forKey: .comments)
  }
  
  init(post_id: String, product_id: String?, title: String?, content: String?, content1: String?, content2: String?, content3: String?, content4: String?, content5: String?, createdAt: String, creator: UserDTO, files: [String], likes: [String], likes2: [String], hashTags: [String], comments: [CommentDTO]) {
